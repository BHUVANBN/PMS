...
const EmployeeCreatePage = () => {
  ...
  // HR can only create these roles
          ...
          {success && (
            <div className="bg-green-50 border border-green-200 rounded-lg p-4 mb-6">
              <div className="flex">
                ...
                <div className="ml-3">
                  <h3 className="text-sm font-medium text-green-800">Employee Created Successfully!</h3>
                  <p className="text-sm text-green-700 mt-1">Redirecting to employee list...</p>
                </div>
              </div>
            </div>
          )}
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="space-y-6">
                    ...
                    <div>
                      ...
                      <p className="mt-1 text-sm text-gray-500">
                        HR can assign: Employee, Developer, Tester, Marketing, Sales, or Intern roles
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex justify-end space-x-3 pt-6 border-t border-gray-200">
                  ...
                  <button
                    type="submit"
                    disabled={loading}
                    className="bg-pink-600 hover:bg-pink-700 disabled:bg-pink-400 text-white px-6 py-2 rounded-lg transition-colors flex items-center"
                  >
                    {loading && (
