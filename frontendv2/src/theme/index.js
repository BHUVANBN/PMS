  ...
  components: {
    MuiCssBaseline: {
      styleOverrides: {
        body: {
          minHeight: '100vh',
          background: 'linear-gradient(135deg, rgba(147, 197, 253, 0.3) 0%, rgba(196, 181, 253, 0.3) 50%, rgba(251, 207, 232, 0.3) 100%)',
    ...
    MuiButton: {
      ...
      styleOverrides: {
        ...
        containedPrimary: {
          ...
          ':hover': { filter: 'brightness(1.05)', boxShadow: '0 12px 28px rgba(99,102,241,0.45)' },
        },
